...
async def bot_start(message: types.Message):
    try:
        ...
        if nomer[1] == message.contact:
            ...
            await message.answer("<b>Easy Work botiga xush kelibsiz</b>", reply_markup=menuuz)

    except:
        await message.answer("Bot ishlashi uchun <b>Raqam Jo'natish ✅</b> tugmasini bosin", reply_markup=royxat)
